# Generated by Django 3.2.6 on 2021-08-30 20:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers_quantity', models.IntegerField(default=0, help_text=('Quantity of followers of this user.Stores the value to perform less queries.Increase 1 when another user begins to follow this user.',), verbose_name='followers')),
                ('following_quantity', models.IntegerField(default=0, help_text=('Quantity of users that this user is following.', 'Stores the value to perform less queries.Increase 1 when this user begins to follow another user.'), verbose_name='following')),
